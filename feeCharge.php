...
$key = '198BE3F2E8C75A53F38C1C4A5B6DBA27';
...
echo $url_napas = 'https://sandbox.napas.com.vn/gateway/vpcpay.do?vpc_Version='.$vpc_Version.'&vpc_Command='.$vpc_Command.'&vpc_AccessCode='.$vpc_AccessCode.'&vpc_MerchTxnRef='.$vpc_MerchTxnRef.'&vpc_Merchant='.$vpc_Merchant.'&vpc_OrderInfo='.$vpc_OrderInfo.'&vpc_Amount='.$vpc_Amount.'&vpc_ReturnURL='.$vpc_ReturnURL.'&vpc_BackURL='.$vpc_BackURL.'&vpc_Locale='.$vpc_Locale.'&vpc_CurrencyCode='.$vpc_CurrencyCode.'&vpc_TicketNo='.$vpc_TicketNo.'&vpc_PaymentGateway='.$vpc_PaymentGateway.'&vpc_CardType='.$vpc_CardType.'&vpc_SecureHash='.$vpc_SecureHash;
?>
