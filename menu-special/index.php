        ...
        <div class="inner">
            ...
            <ul class="listCountries clearfix f_lapresse pc">
                <?php
                    ...
                    $i++;    
                ?>
				<li><a href="<?php echo APP_URL; ?>food/#menuFood" id="call<?php echo $i; ?>"><?php echo $cat->name; ?></a></li>
                <?php } ?>
			</ul>
            <p class="btnMenu_sp sp" id="menu1"><a href="<?php echo APP_URL; ?>food/#menuFood"><?php $term1 = get_term( 5, foodcat ); echo $term1->name; ?></a></p>
...
<script>
    $(document).ready(function(){
        ...
        $('#call2').parent('li').addClass('active');
