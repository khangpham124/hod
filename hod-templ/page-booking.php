...
<div id="wrapper">
    ...
    <div class="greyBox bookingBox">
            ...
            <label class="labelStep">Fullname<span>*</span></label>
            ...
            <label class="labelStep">Phone<span>*</span></label>
            <div class="select-style">
            <select name="zip" id="zip" require>
            ...
            <label class="labelStep">Email<span>*</span></label>        
